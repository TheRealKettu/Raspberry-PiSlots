...
class Game:
            ...
            for event in pygame.event.get():	
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_LEFT and self.keys == 1:
                        if credit > 0:
                            if credit - self.bet < 0:
                                self.bet = credit
                            credit = credit - self.bet
                            self.randi()
                            self.check()
                            self.roll(img)
                            self.screen.blit(self.background, (0, 0))
    ...
    def draw_side(self):
        ...
        text_surface = digifont.render("PISLOTS", True, [255, 0, 0])
        self.screen.blit(text_surface, (470, 50))
        ...
        text_surface = digifont.render(str(credit), True, [255, 0, 0])
        self.screen.blit(text_surface, (500, 350))
    ...
    def endthegame(self, scr):
        ...
        if credit > scrb:
            ...
            self.screen.blit(text_surface, (60, 80))
            text_surface = font.render("New high score: "+str(credit), True, [255, 255, 255])
            self.screen.blit(text_surface, (60, 100))
...
if __name__ == "__main__":
    ...
    pygame.display.update()
    pygame.display.set_caption("piSLOTS")
